    ...
    setTimeout(async () => {
      ...
      if (Seek) {
        ...
        const PlayEmbed = new Discord.MessageEmbed()
          ...
          .setTitle("<a:0_0:784747064110088212>" + " NOW PLAYING " + "<a:0_0:784747064110088212>")
          .addField(`NAME: `,`[${options.Play.Title}](${options.Play.Link})`, true)
          .setTimestamp()
        .setFooter(`REQUESTED BY: ${message.author.username}`)
 Db.TextChannel.send(PlayEmbed).catch(e => {
          Db.TextChannnel.send(`Something went wrong while playing the song.`)
 });
